...
<div class="container">
    <form action="qwriteOk.jsp" method="post" name="frm" enctype="multipart/form-data">
        <div>
       ...
       <div class="back">
        ...
        <button onclick="location.href='qboard.jsp'" class="btn btn-success">목 록</button>
    </form>
</div>
