...
<%
	...
	try{
		...
		String sql = "INSERT INTO board(btitle, bcontent, mno, type, rdate, mdate) VALUES (?, ?, ?, 'Q', NOW(), NOW())"; // Q 타입으로 Q&A 게시판 분류
		...
		//현재 삽입된 게시글의 기본키(bno)값을 조회하세요.
				...
				if(realFileNM != null && originFileNM != null){  // 첨부파일 null 값 테스트
